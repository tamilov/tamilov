      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          <motion.button 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-foreground font-bold hover:text-accent transition-colors flex items-center group"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          {notes.map((note, idx) => (
            <motion.div
              ...
              className="border-2 border-foreground bg-white p-6 sm:p-8 rounded-2xl shadow-brutal flex flex-col group cursor-pointer hover:-translate-y-1 hover:shadow-brutal-lg transition-all"
